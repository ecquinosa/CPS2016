...
Public Class ReportG_GoodCards
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CPS2016.ReportG_GoodCards.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportG_GoodCards
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportG_GoodCards = New ReportG_GoodCards()
        rpt.Site = Me.Site
        Return rpt
    End Function
