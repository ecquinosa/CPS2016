...
Public Class RptRejectReportByPO
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptRejectReportByPO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CPS2016.RptRejectReportByPO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptRejectReportByPO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptRejectReportByPO = New RptRejectReportByPO()
        rpt.Site = Me.Site
        Return rpt
    End Function
