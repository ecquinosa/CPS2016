...
Public Class SubRptRelPOMatMaterial
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SubRptRelPOMatMaterial.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CPS2016.SubRptRelPOMatMaterial.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_MaterialID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedSubRptRelPOMatMaterial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SubRptRelPOMatMaterial = New SubRptRelPOMatMaterial()
        rpt.Site = Me.Site
        Return rpt
    End Function
