...
Public Class RptRejectReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CPS2016.RptRejectReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptRejectReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptRejectReport = New RptRejectReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
