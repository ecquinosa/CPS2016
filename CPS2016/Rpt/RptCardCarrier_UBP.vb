...
Public Class RptCardCarrier_UBP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CPS2016.RptCardCarrier_UBP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCardCarrier_UBP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCardCarrier_UBP = New RptCardCarrier_UBP()
        rpt.Site = Me.Site
        Return rpt
    End Function
