...
Public Class RptCertiOfDeletion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CPS2016.RptCertiOfDeletion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCertiOfDeletion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCertiOfDeletion = New RptCertiOfDeletion()
        rpt.Site = Me.Site
        Return rpt
    End Function
