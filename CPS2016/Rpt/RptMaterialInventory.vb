...
Public Class RptMaterialInventory
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptMaterialInventory.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CPS2016.RptMaterialInventory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMaterialInventory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMaterialInventory = New RptMaterialInventory()
        rpt.Site = Me.Site
        Return rpt
    End Function
