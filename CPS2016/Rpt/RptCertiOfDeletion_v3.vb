...
Public Class RptCertiOfDeletion_v3
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptCertiOfDeletion_v3.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CPS2016.RptCertiOfDeletion_v3.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_POID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptCertiOfDeletion_v3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCertiOfDeletion_v3 = New RptCertiOfDeletion_v3()
        rpt.Site = Me.Site
        Return rpt
    End Function
