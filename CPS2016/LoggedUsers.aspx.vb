...
Public Class LoggedUsers
    ...
    Private Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not SharedFunction.IsHaveAccessToPage(SharedFunction.RoleModules(Page.User.Identity.Name), DataKeysEnum.ModuleID.LoggedUsers) Then
    ...
    Protected Sub LinkButton1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        'Dim ID As Integer = xGrid.GetRowValues(index, "ID")
        'UploadData(strPurchaseOrder.Trim, strBatch.Trim) ', ID)
    End Sub
