<%@ Page Language="VB" AutoEventWireup="true" MasterPageFile="~/Main.master" CodeBehind="ForUploadCMSReject.aspx.vb" Inherits="CPS2016.ForUploadCMSReject" %>
       ...
       <div style="height: 19px; background-color: #D2DCE3; padding-top: 2px; padding-left: 2px; padding-bottom: 2px;">
        ...
        <dx:ASPxGridView ID="xGrid" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="File" FieldName="FileName" 
                        VisibleIndex="2" Width="60%">
                    ...
                    <dx:GridViewDataTextColumn Caption="Approx. Qty." FieldName="Quantity" 
                        UnboundType="Boolean" VisibleIndex="3" Width="10%">
                    ...
                    <dx:GridViewDataHyperLinkColumn VisibleIndex="8" Caption=" ">
                        <DataItemTemplate>
                            <asp:linkbutton ID="LinkButton1" runat="server" Text="Upload" OnClientClick="ShowProcessingPanel('Are you sure you want to upload data?')" onclick="LinkButton1_Click" ForeColor="#FF6600"></asp:linkbutton>
                        </DataItemTemplate>
                    </dx:GridViewDataHyperLinkColumn>
                    <dx:GridViewDataHyperLinkColumn VisibleIndex="9" Caption=" " Visible="False">
                        <DataItemTemplate>
                            <asp:linkbutton ID="LinkButton2" runat="server" Text="Delete" OnClientClick="ShowProcessingPanel('Are you sure you want to delete data?')" onclick="LinkButton2_Click" ForeColor="#FF6600"></asp:linkbutton>
                        </DataItemTemplate>
                    </dx:GridViewDataHyperLinkColumn>
