<%@ Page Language="VB" AutoEventWireup="true" MasterPageFile="~/Main.master" CodeBehind="RejectCard.aspx.vb" Inherits="CPS2016.RejectCard" %>
...
<div style="float: left; width: 510px; top: 0px; left: 0px; padding-bottom: 15px;">
	...
	e.processOnServer = confirm('Are you sure you want to reject the card(s) and continue?');
    ...
    <div style="float: left; width: 507px; top: 0px; left: 0px; padding-bottom: 15px;">
                            <div style="width: 95px; float: left; height: 21px;">Barcode/ CRN</div>
                            <div id="divSearch0" style="width: 410px; float: right;">
                                <dx:ASPxButtonEdit ID="txtParam" runat="server" ClientInstanceName="txtParam" 
                                    Height="20px" NullText="enter barcode or crn" Width="300px">
    ...
    <div style="float: left; width: 507px; top: 0px; left: 0px; padding-bottom: 15px;">
                            <div style="width: 95px; float: left; height: 21px;">Reason</div>
                            <div id="div1" style="width: 410px; float: right;">
                                
                                
                                <asp:CheckBox ID="chkQuality" runat="server" Text="Quality rotated defect" />
                                <asp:CheckBox ID="chkChip" runat="server" Text="Defective chip" />
    ...
    <div style="float: left; width: 511px; top: 0px; left: 0px; padding-bottom: 5px;">
        ...
        </dx:ASPxButton>&nbsp;<dx:ASPxLabel ID="lblStatus" runat="server" Text="Ready">
        </dx:ASPxLabel>
    </div>
        ...
        <ItemTemplate>
            <div id="itCont" style="width: 439px">
                ...
                <table style="width:98%; font-size: 12px;">
                    <tr>
                        <td rowspan="7" valign="middle" style="width: 131px" align="left">
           ...
           <dx:ASPxGridView ID="xGrid" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        <dx:GridViewCommandColumn 
                            ShowClearFilterButton="True" VisibleIndex="22" 
...
<EditFormSettings Visible="False"></EditFormSettings>
    ...
    <CellStyle HorizontalAlign="Center">
                        ...
                        <dx:GridViewDataTextColumn Caption="Reject Type" FieldName="RejectType" 
                            VisibleIndex="21">
                        </dx:GridViewDataTextColumn>
                    </Columns>
                    <SettingsBehavior ConfirmDelete="True" FilterRowMode="OnClick" />
