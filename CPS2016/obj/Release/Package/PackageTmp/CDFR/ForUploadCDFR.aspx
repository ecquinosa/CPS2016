<%@ Page Language="VB" AutoEventWireup="true" MasterPageFile="~/Main.master" CodeBehind="ForUploadCDFR.aspx.vb" Inherits="CPS2016.ForUploadCDFR" %>
       ...
       <div style="height: 19px; background-color: #D2DCE3; padding-top: 2px; padding-left: 2px; padding-bottom: 2px;">
        ...
        <dx:ASPxGridView ID="xGrid" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="CDFR" FieldName="GSUFilename" 
