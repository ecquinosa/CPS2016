<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RoleActivity.aspx.vb" Inherits="CPS2016.RoleActivity" %>
...
<body>
    ...
    <div>
            ...
            <dx:ASPxGridView ID="xGrid" runat="server" AutoGenerateColumns="False" 
                EnableTheming="True" Theme="Office2010Blue" KeyFieldName="ActivityID" 
                Width="300px">
...
<Settings ShowFilterRow="True"></Settings>
                ...
                <Columns>
                    ...
                    <dx:GridViewDataButtonEditColumn Caption="Activity" FieldName="ActivityDesc" 
...
<EditFormSettings RowSpan="1" VisibleIndex="1"></EditFormSettings>
                    ...
                    <dx:GridViewDataTextColumn 
                        VisibleIndex="0" Caption="ActivityID" FieldName="ActivityID" ReadOnly="True" 
                        Width="20px">
