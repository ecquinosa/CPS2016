...
Public Class Inventory
    ...
    Private Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not SharedFunction.IsHaveAccessToPage(SharedFunction.RoleModules(Page.User.Identity.Name), DataKeysEnum.ModuleID.Inventory) Then
